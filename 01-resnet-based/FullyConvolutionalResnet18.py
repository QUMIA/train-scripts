...
class FullyConvolutionalResnet18(models.ResNet):
    def __init__(self, num_classes=4, pretrained=False, **kwargs):
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        cv2.imwrite("scaled_score_map.jpg", score_map * 255)
        cv2.imwrite("activations_and_bbox.jpg", masked_image)
